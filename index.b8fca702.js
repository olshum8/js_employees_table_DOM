...
var _createNewEmploee = require("./createNewEmploee");
"use strict";
...
submit.addEventListener("click", (evnt)=>{
    ...
    if (inputName.trim().length < 4) return (0, _createNotification.createNotification)("error", "Name should be at least 4 characters");
    if (position.trim().length < 1) return (0, _createNotification.createNotification)("error", "The name of the position should be provided");
    if (age < 18 || age > 90) return (0, _createNotification.createNotification)("error", "The age should be more than 18 and less than 90.");
    else {
        (0, _createNewEmploee.createNewEmploee)();
        (0, _createNotification.createNotification)("success", "The information has been gradually added to the list.");
    }
}); // dblclick

},{"./sortTable":"ihh80","./createNotification":"fafu8","./createNewEmploee":"7Vvu5"}],"ihh80":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sortTable", ()=>sortTable);
function sortTable(index) {
    ...
    rows.sort((rowA, rowB)=>{
        ...
        if (isNumeric) return dataOrder === "asc" ? cellA - cellB : cellB - cellA;
        else return dataOrder === "asc" ? cellA.localeCompare(cellB) : cellB.localeCompare(cellA);
    });
    currentHeader.setAttribute("data-order", dataOrder === "asc" ? "desc" : "asc");
...
},{}],"fafu8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7Vvu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createNewEmploee", ()=>createNewEmploee);
function createNewEmploee() {
    const inputName = document.getElementById("name").value;
    const position = document.getElementById("position").value;
